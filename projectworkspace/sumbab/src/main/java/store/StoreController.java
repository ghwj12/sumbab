...
public class StoreController {
	...
	@RequestMapping(value = "/store/registerStep1", method = RequestMethod.GET)
	public String regitStore1() {
	...
	@RequestMapping(value = "/store/registerStep1-2", method = RequestMethod.POST) // step1에서 submit->register2로 보냄
	public String regitStore2(StoreRegisterRequest regReq) { // regitrequest 요청
	...
	@RequestMapping(value = "/store/registerStep1-2", method = RequestMethod.GET) // get으로 접근하면 regit1로 돌려보내기
	...
	@RequestMapping(value = "/store/completeRegisterR", method = RequestMethod.POST) // 카테고리 작성 후 마지막 complete 페이지 요청
	...
	@RequestMapping(value = "/store/completeRegisterC", method = RequestMethod.POST) // 카테고리 작성 후 마지막 complete 페이지 요청
